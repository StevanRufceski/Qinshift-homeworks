...
const instituteForEducation = new Institution ("Skopje", 1000);
console.log(instituteForEducation)
console.log(instituteForEducation.validateCapacity(0, instituteForEducation.capacity))
console.log(instituteForEducation.validateCapacity(10, instituteForEducation.capacity))
console.log(instituteForEducation.validateCapacity(1050, instituteForEducation.capacity))
console.log(instituteForEducation)

function Academy(name, subjects, students, start, end){
    Object.setPrototypeOf(this, new Institution())
    this.name = name
...
const programming = new Course ("Full stack programming course", 500);
console.log(programming)
console.log(programming.validatePrice(5))
console.log(programming.validatePrice(-5))

function Subject(title, numberOfClasses, isElectable, academy, students){
    Object.setPrototypeOf(this, new Course())
    this.title = title
